...
public class PrgState {
    ...
    private int id = 0;
    private MyILock<Integer,Integer> lockTable;


    public PrgState(MyIStack<IStmt> exeStack, MyIDictionary<String, Integer> symTable, MyIList<Integer> out, MyIFileDictionary<Integer, Pair<String, BufferedReader>> fileTable,MyIHeap<Integer,Integer> heap,MyILock<Integer,Integer> lock,IStmt prg) {
    ...
    public MyILock<Integer, Integer> getLockTable() {
        return lockTable;
    }
