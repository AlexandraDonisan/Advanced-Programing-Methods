...
public class SceneController2 {
    ...
    @FXML private  TableColumn<Pair<Integer, Integer>,String> idLockColumn;
    @FXML private  TableColumn<Pair<Integer, Integer>,String> prgStateIDColumn;
    ...
    @FXML private void initialize() {
        ...
        idLockColumn.setCellValueFactory(new PropertyValueFactory<>("key"));
        prgStateIDColumn.setCellValueFactory(new PropertyValueFactory<>("value"));
    ...
    private void updateAllScenes()
    {
        if(!ctrl.getNumberOfPrograms().equals("0"))
        {
            ...
            ArrayList<Pair<Integer,Integer>> lockTableN = ctrl.getLockTableGUI(index);
            ObservableList<Pair<Integer,Integer>> lockN = FXCollections.observableArrayList(lockTableN);
            lockTable.setItems(lockN);
