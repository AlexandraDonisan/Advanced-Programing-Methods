...
public class FileTable implements MyIFileDictionary<Integer,Pair<String, BufferedReader>>
{
    ...
    @Override
    public ArrayList<Pair<String, BufferedReader>> getPairs() {
        ArrayList<Pair<String, BufferedReader>> arr = new ArrayList<>();
    ...
    @Override
    public ArrayList<Pair<Integer, String>> getAllPairsWithoutBF() {
        ArrayList<Pair<Integer, String>> arr = new ArrayList<>();
        dict.forEach((k,v)->arr.add(new Pair<>(k,v.getKey())));
        return arr;
    }
