...
public class SceneController {
    ...
    private ObservableList<IStmt> getOptions()
    {
        ...
        //fork(await(cnt);wh(v2,rh(v2)*10));wh(v2,rh(v2)*10));print(rh(v2)));
        CompStmt body3 = new CompStmt(new Await("cnt"),new CompStmt(
                new heapWritingExp("v1",new ArithExp(3,new heapReadingExp("v1"),new ConstExp(10))),
                new PrintStmt(new heapReadingExp("v1"))));
        ForkStmt fork3 = new ForkStmt(body3);
        CompStmt body4 = new CompStmt(new Await("cnt"),
                new CompStmt(new heapWritingExp("v2",new ArithExp(3,new heapReadingExp("v2"),
                        new ConstExp(10))),
                        new CompStmt(new heapWritingExp("v2",new ArithExp(3,new heapReadingExp("v2"),
                                new ConstExp(10))), new PrintStmt(new heapReadingExp("v2")))));
        ForkStmt fork4 = new ForkStmt(body4);
        IStmt ex21 = new CompStmt(new1,new CompStmt(new2,new CompStmt(new3,new CompStmt(newBar,new CompStmt(fork3,new CompStmt(fork4,
                new CompStmt(new Await("cnt"),new PrintStmt(new heapReadingExp("v3")))))))));
        return FXCollections.observableArrayList(ex1,ex2,ex3,ex4,ex5, ex6,ex7,ex8,ex9,ex10,ex11,ex12,ex13,ex14,ex17,ex18, ex19, ex20,ex21);
